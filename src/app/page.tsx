  ...
  return (
    <div className="min-h-[calc(100vh-8rem)] flex items-center justify-center px-6">
      <div className="w-full max-w-2xl">
        ...
        <h1 className="text-5xl md:text-6xl font-light leading-tight mb-4 tracking-tight">
          are you holding,
          <br />
          chasing,
          <br />
          <span className="text-[var(--color-text-dim)]">or bundling?</span>
        </h1>
        <p className="text-[var(--color-text-dim)] mb-10 max-w-lg">
